一键安装运行命令:
bash <(curl -Ls https://raw.githubusercontent.com/kuisa/bp-panel-alpine/main/ins.sh) && bash <(curl -Ls https://raw.githubusercontent.com/kuisa/bp-panel-alpine/main/bp.sh) && pkill -f 'node server/index.js' && curl -o /root/browser-launcher.js -Ls  https://raw.githubusercontent.com/kuisa/bp-panel-alpine/main/browser-launcher.js && cp /root/browser-launcher.js /opt/browser-panel/server/runtime/browser-launcher.js && nohup /usr/bin/node /opt/browser-panel/server/index.js > /dev/null 2>&1 &
